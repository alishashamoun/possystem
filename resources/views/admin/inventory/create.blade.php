            ...
            <div class="container-fluid">
                ...
                <div class="py-3 d-flex align-items-sm-center flex-sm-row flex-column">
                    <div class="flex-grow-1">
                        <h4 class="fs-18 fw-semibold mt-4">Inventory Create</h4>
                    </div>
                </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-xs-6 col-sm-6 col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control my-2" id="sku" name="sku"
                                                    required>
                                            </div>
                                        </div>
                                        <div class="col-xs-6 col-sm-6 col-md-6">
                                        ...
                                        <div class="col-xs-6 col-sm-6 col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="number" class="form-control my-2" id="cost_price" name="cost_price"
                                                    required>
                                            </div>
                                        </div>
                                        <div class="col-xs-6 col-sm-6 col-md-6">
